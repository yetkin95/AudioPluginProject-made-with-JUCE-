...
//=================================================================================
//juce::AudioProcessorParameter* parameter;               //parameter definition from AudioProcessorParametyer class(pointer)
//int index = 0;
...
#endif
{                           //add and specify range of the parameter 
    addParameter (volume = new juce::AudioParameterFloat ("Volume", "Volume", 0.0f, 1.0f, 0.001f));
}
...
void NewProjectAudioProcessor::sliderValueChanged(juce::Slider* slider)
{
